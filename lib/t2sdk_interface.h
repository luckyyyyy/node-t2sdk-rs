...
struct IBizMessage : public IKnown
{
	...
	//20190805 yanz #157077
	virtual void FUNCTION_CALL_MODE SetInternalLicense(const int nInternalLicense) = 0;
	virtual const int FUNCTION_CALL_MODE GetInternalLicense() = 0;
	virtual void FUNCTION_CALL_MODE SetAppReserved(const void* lpAppReserved, int nLen) = 0;
	virtual const void* FUNCTION_CALL_MODE GetAppReserved(int& nLen) = 0;
};
...
//20190805 yanz #157077
int FUNCTION_CALL_MODE t2sdk_library_init();

int FUNCTION_CALL_MODE t2sdk_library_end();
}
