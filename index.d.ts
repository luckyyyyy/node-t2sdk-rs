...
export interface JsBizRouteInfo {
  ospfName: string
  nbrName: string
  svrName: string
  pluginId: string
...
export declare class BizMessage {
  ...
  getPacketId(): number
  /** 设置目的地路由 */
  setTargetInfo(jsTargetInfo: JsBizRouteInfo): void
  /** 获取目的地路由 */
  getTargetInfo(): JsBizRouteInfo
  /** 设置发送者路由 */
  setSendInfo(jsSendInfo: JsBizRouteInfo): void
  /** 获取发送者路由 */
  getSendInfo(): JsBizRouteInfo
  /** 设置错误号 */
